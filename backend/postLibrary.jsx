...
export default function PostLibraryScreen({ navigation }) {
  ...
  const savePostPicture = async () => {
    ...
    const existingRef = firebase.storage().ref().child('postImage').child(filename);
    try {
    ...
    try {
      ...
      const ref = firebase.storage().ref().child('postImage').child(filename);
    ...
    <View style={styles.container}>
      <View style={styles.header}>
        ...
        {isEditing && ( // Show the "Save" button only when in editing mode
            <TouchableOpacity style={styles.saveButton} onPress={savePostPicture}>
